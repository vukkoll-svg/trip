...
- [ ] Registracija: Travelpayouts + Amadeus for Developers (vidi ISTRAZIVANJE.md)
- [ ] Node.js backend (Express) sa adapterima za izvore podataka
- [ ] Aviasales Data API → najjeftiniji letovi po destinaciji/mesecu
- [ ] Hotellook API → najjeftiniji hoteli za iste datume
